...
h = ismrmrd_to_nifti.extract_ismrmrd_parameters_from_img_headers(data_header, connection_header);

% Create nii struct based on img
nii_empty = nii_tool('init', double(img)); 
...
h2{1}=h;
pf.lefthand = 1; %to include in a function ?
